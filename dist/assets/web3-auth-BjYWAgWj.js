import{e as r}from"./local-storage-BFjGCbUB.js";async function c(){if(!window.ethereum)throw new Error("MetaMaskがインストールされていません。");try{const e=(await window.ethereum.request({method:"eth_requestAccounts"}))[0],a=`CTCアプリケーションへようこそ!
...
//# sourceMappingURL=web3-auth-BjYWAgWj.js.map
